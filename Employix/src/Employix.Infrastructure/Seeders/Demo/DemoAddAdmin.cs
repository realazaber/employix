...
namespace Employix.Infrastructure.Seeders.Demo
{
    public static class DemoAddAdmin
    {
        public static async Task AddAdmin(UserManager<User> _userManager)
        {
            ...
            {
                UserName = "admin@emploix.com",
                Email = "admin@emploix.com",
            ...
            await _userManager.AddToRoleAsync(adminUser, "UserManager");
            await _userManager.AddToRoleAsync(adminUser, "DepartmentManager");
            await _userManager.AddToRoleAsync(adminUser, "TeamManager");
        }
    }
}
