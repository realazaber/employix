...
test('AdminProfileNavigation', async ({ page }) => {
    await page.goto("Account/Login");
    await page.getByRole('textbox', { name: 'name@example.com' }).click();
    await page.getByRole('textbox', { name: 'name@example.com' }).fill('admin@employix.com');
    await page.getByRole('textbox', { name: 'name@example.com' }).press('Tab');
    await page.getByRole('textbox', { name: 'password' }).fill('Admin1235*');
